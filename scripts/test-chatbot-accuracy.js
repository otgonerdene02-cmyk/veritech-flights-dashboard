...
function buildCases(rows) {
  ...
  const cases = [
    ...
    {
      // dir/ou/сар зэрэг өөр ямар ч шүүлтүүр идэвхжихгүй, зөвхөн байршил
      // "танигдаагүй" эсэхийг цэвэрхэн шалгах query — "ирсэн"/"явсан"/"руу"
      // мэт үг орвол dir шүүлт легитимээр нэмэгддэг тул бүтэн нийт дүн
      // гарахгүй (энэ код буруу биш, тестийн query буруу сонгосон байсан).
      name: 'Танигдаагүй нэр — warning унтраагдаагүй мөртлөө нийт дүн зөв',
      query: 'Атлантис хэдэн зорчигчтэй бэ?',
      expected: total,
